...
Acknowledgments
elementsofai.com — Building AI course framework and project structure
CDC FluView — Regional flu surveillance data
XGBoost — Gradient boosting library
HIPAA Safe Harbor guidelines — De-identification standards
